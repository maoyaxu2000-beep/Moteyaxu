...
window.DATA.units = [
  ...
  { id:'u6',  title:'无线电与团队协作', titleEn:'Radio & Teamwork',      icon:'radio',   categories:['ICAO字母解读','无线电数字读法','无线电通话','客舱广播用语','团队协作口令','机组资源管理','结束用语'] },
  ...
  { id:'u9',  title:'应急与医疗',       titleEn:'Emergency & Medical',   icon:'medical', categories:['应急','驾驶舱门安全','医疗急救','身体部位伤情','复飞与备降','天气预警补充','客舱异物与设备故障','卫生与消毒'], story:'sc_medical_01' },
